...
function handleModPermissions() {
    ...
    $("#cs-allow_voteskip").attr("disabled", CLIENT.rank < 8);
    $("#cs-voteskip_ratio").val(CHANNEL.opts.voteskip_ratio);
    $("#cs-voteskip_ratio").attr("disabled", CLIENT.rank < 8);
    ...
    $("#cs-playlist_max_per_user").attr("disabled", CLIENT.rank < 9);
    $("#cs-playlist_max_duration_per_user").val(formatTime(CHANNEL.opts.playlist_max_duration_per_user));
    $("#cs-playlist_max_duration_per_user").attr("disabled", CLIENT.rank < 9);
    ...
    $("#cs-maxlength").attr("disabled", CLIENT.rank < 9);
